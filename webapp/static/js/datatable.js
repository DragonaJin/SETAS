    ...
    return {
        ...
        init: function(options) {
            ...
            if ($('.table-actions-wrapper', tableContainer).size() === 1) {
                ...
                $('.selectEl').each(function(i, n){
                    var me = $(this);
                    var placeholder = me.data('placeholder')||'';
                    me.select2({'placeholder': placeholder, 'height': '12px'});
                })
            }
        ...
        setAjaxData:function(){
            ...
            the.setAjaxParam("filter", JSON.stringify(filterParams));
        ...
        resetSelectoption :function(){
            $("#select2-approval_status-4n-container").empty();
        },
